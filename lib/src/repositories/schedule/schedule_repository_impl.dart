...
class ScheduleRepositoryImpl implements ScheduleRepository {
  ...
  Future<Either<RepositoryException, Nil>> scheduleClient(
    ...
    try {
      ...
      log('Erro ao agendar cliente', error: e, stackTrace: s);

      return Failure(RepositoryException(message: 'Erro ao agendar cliente'));
    }
  }
  ...
  Future<Either<RepositoryException, List<ScheduleModel>>> findScheduleByDate(
    ...
    try {
      ...
      final List<ScheduleModel> schedules =
          data.map((e) => ScheduleModel.fromMap(e)).toList();
      return Sucess(schedules);
    } on DioException catch (e, s) {
      log('Erro ao buscar agendamentos por data', error: e, stackTrace: s);
      return Failure(
          RepositoryException(message: 'Erro ao buscar agendamento por data'));
